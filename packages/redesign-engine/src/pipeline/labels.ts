...
export const PIPELINE_STAGE_LABELS: Record<RedesignStage, string> = {
  ...
  [RedesignStage.CONTENT_VALIDATED]: 'Content validation',
  [RedesignStage.GRAPH_BUILT]: 'Semantic graph',
  [RedesignStage.CMS_IMPORT_READY]: 'Import contract QA',
  ...
  [RedesignStage.RENDER_VALIDATED]: 'Render QA',
  [RedesignStage.VISUAL_VALIDATED]: 'Visual acceptance QA',
  [RedesignStage.QA_FAILED]: 'QA failed',
  [RedesignStage.HUMAN_REVIEW_READY]: 'Ready for human review',
