...
const SITES: Site[] = [
  ...
  },
  {
    ...
    created: "2025-01-15",
    lastBuild: "2025-08-21",
    lastAudit: "—",
    mediaCount: 42,
    previewCaptured: "2025-08-21",
  ...
  },
  {
    ...
    domain: "—",
    status: "DRAFT",
    template: "construction-premium-v2",
    pages: 4,
    projects: 0,
    news: 0,
    ...
    lastAudit: "—",
    mediaCount: 7,
    attention: "Missing domain",
    attentionAction: "Fix",
    previewCaptured: "2025-08-25",
  ...
  },
  {
    ...
    created: "2025-06-10",
    lastBuild: "2025-08-22",
    lastAudit: "2025-08-22",
    mediaCount: 61,
    attention: "Preview build failed",
    attentionAction: "Retry",
    previewCaptured: "2025-08-22",
    image: IMG("1567943183748-3a7542120c90"),
  },
  {
    id: "5",
    name: "Кровля Профи",
    domain: "krovlya-profi.ru",
    status: "DEMO_APPROVED",
    template: "roofing-clean-v1",
    pages: 5,
    projects: 8,
    news: 2,
    lastUpdated: "2025-08-19",
    created: "2025-05-20",
    lastBuild: "2025-08-19",
    lastAudit: "2025-08-18",
    mediaCount: 38,
    previewCaptured: "2025-08-19",
    image: IMG("1601074231509-dce351c05199"),
  },
  {
    id: "6",
    name: "ТеплоДом",
    domain: "teplodom.by",
    status: "ACTIVE",
    template: "residential-warm-v1",
    pages: 9,
    projects: 21,
    news: 12,
    lastUpdated: "2025-08-25",
    created: "2024-09-14",
    lastBuild: "2025-08-25",
    lastAudit: "2025-08-24",
    mediaCount: 156,
    previewCaptured: "2025-08-25",
    image: IMG("1774544368113-b66148dab467"),
  },
  {
    id: "7",
    name: "ModuloFlex",
    domain: "moduloflex.com",
    status: "ARCHIVED",
    template: "construction-modern-v1",
    pages: 6,
    projects: 5,
    ...
    created: "2024-07-01",
    lastBuild: "2025-03-10",
    lastAudit: "2025-03-09",
    mediaCount: 29,
    previewCaptured: "2025-03-10",
    image: IMG("1483366774565-c783b9f70e2c"),
  },
  {
    id: "8",
    name: "МегаСтрой Инжиниринг",
    domain: "megastroy-ing.ru",
    status: "CONTENT_READY",
    template: "construction-premium-v2",
    pages: 5,
    projects: 0,
    ...
    lastAudit: "—",
    mediaCount: 14,
    attention: "CMS import incomplete",
    attentionAction: "Open",
    previewCaptured: "2025-08-26",
    image: IMG("1781692079653-7e8222a40bda"),
  },
];
