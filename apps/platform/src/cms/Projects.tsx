          ...
          <div className="max-w-[680px] mx-auto flex flex-col gap-5">
            ...
            <div>
              ...
              <div className="bg-surface border border-border rounded p-4">
                {coverImageId && <p className="text-[12px] text-text-muted mb-2 mono">{coverImageId} <button onClick={() => { setCoverImageId(''); markDirty() }} className="ml-2 text-danger">Remove</button></p>}
                <label className="h-[120px] border border-dashed border-border rounded flex flex-col items-center justify-center gap-2 text-text-subtle hover:bg-surface-raised hover:border-accent hover:text-accent cursor-pointer transition-colors">
                  ...
                  {uploading ? 'Uploading…' : <><IconUpload size={18} /><span className="text-[12px]">Click to upload cover</span><span className="text-[11px] text-text-subtle">JPG, PNG — recommended 1600×900</span></>}
                </label>
              </div>
            </div>
